...
{
    public record CreateBankAccountCommand : IRequest<Result>
    {
    ...
    public class CreateBankAccountCommandHandler : IRequestHandler<CreateBankAccountCommand, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IIdentityService _identityService;
        public CreateBankAccountCommandHandler(IApplicationDbContext context, IIdentityService identityService)
        {
            _context = context;
        ...
        {
            var user = _identityService.CreateBankInfo
